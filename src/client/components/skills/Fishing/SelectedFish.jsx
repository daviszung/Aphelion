      ...
      <div className={style.rightBody}>
        <button className={style.fishActionBtn} onClick={() => {
          ...
          <div className={style.progressBarContainer}>
            <div className={style.progressBar} style={selectedAction === selectedFish ? {'animation': `${style.load} ${(actionTimeValues[selectedAction] / 1000) * ((100 - state.modifiers.fishingRod) / 100)}s linear infinite`} : {width: '0%'}}></div>
          </div>
        </button>
      </div>
    )
